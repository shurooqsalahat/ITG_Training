...
<div>
<input name="uploadedimage" type="file" class="btn btn-default" style="margin-top:20px;" >
<input type="submit" value="Submit" style=" float:right; width:100px; margin-top:1px;" class="btn btn-default">	
</div>
</form>
...
<?php 
   ...
   // get all posts and display it .
		...
		echo ' <button  onclick="redirpost();"  type="button" class="glyphicon glyphicon-trash post" style"float:right;" value="'.$row['id'].'"></button>';
		}
	   echo($row['content']); 
	   echo'</div> ';
       ...
       $numb =  mysqli_num_rows($results);
		...
		echo '<button  onclick="redircomment();"  type="button"class="glyphicon glyphicon-trash comment" value="'.$rows['id'].'"></button>';
